...
<div class="alert alert-info" role="alert"><b>Note</b>: Set or replace <samp>$ETCD_IP</samp> and <samp>$ETCD_PORT</samp> with the appropriate address of your etcd cluster.</div>
...
<div class="alert alert-info" role="alert"><b>Note</b>: You may skip this step if you do not plan on using the Docker Containerizer.</div>
...
<div class="alert alert-info" role="alert"><b>Note</b>: You may skip this step if you do not plan on using the Unified Containerizer.</div>

...
3. Launch `calico/node`:
   ...
   <div class="alert alert-info" role="alert"><b>Note</b>: Ensure you've set or replaced <samp>$ETCD_IP</samp> and <samp>$ETCD_PORT</samp> to point to <a href="prerequisites">your etcd cluster</a>.</div>

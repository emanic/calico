...
<div class="alert alert-danger" role="alert"><b>Important</b>: Modifying Mesos-DNS <b>in DC/OS</b> may break components which rely on Mesos-DNS resolving to Agent IPs. It is instead recommended to use Navstar DNS entries. Skip ahead for information on how to use this alternative DNS service.</div>
...
<div class="alert alert-info" role="alert"><b>Note</b>: Replace 172.24.197.101 with the IP of the public slave where
Marathon-LB is running.</div>

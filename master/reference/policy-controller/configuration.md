...
<div class="alert alert-info" role="alert"><b>Note</b>: When running etcd with TLS enabled, the addresses in <samp>ETCD_ENDPOINTS</samp> must be hostname values, NOT an IP address, such as etcd-host:2379.</div>

...
<div class="alert alert-info" role="alert"><b>Note</b>: Prior to version 2.0.0, 
calicoctl and calico/node set the global default AS number to 64511.  Updating 
your deployment from a pre-2.0.0 version to use the 2.0.0+ calicoctl and 
calico/node container images will not affect the global value that was previously 
set.</div>

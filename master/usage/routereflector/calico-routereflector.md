...
<div class="alert alert-info" role="alert"><b>Note</b>: The API and behavior of the 
calico/routereflector is likely to change in future releases.</div>
...
<div class="alert alert-info" role="alert"><b>Note</b>: If you require TLS/SSL 
enabled etcd, see the <a href="#route-reflector-with-tlsssl-etcd">section below</a>
for details on how to start the route reflector.</div>
